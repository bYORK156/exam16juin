...
#[Route('/robe')]
final class RobeController extends AbstractController
{
    ...
    {
        $produit = new Produit();
        $form = $this->createForm(Produit2Form::class, $produit);
        ...
        return $this->render('robe/new.html.twig', [
            'produit' => $produit,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Produit $produit, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('robe/edit.html.twig', [
            'produit' => $produit,
            'form' => $form,
        ]);
    }
